...
const STATIC_AGENTS: Agent[] = [
  { id: "1", name: "Jack Freedman", name_he: "ג'ק פרידמן", bio: "Jerusalem's luxury real estate specialist. Born and raised in Jerusalem, Jack brings unmatched local expertise and a deeply personal approach to every transaction.", phone: "+972 53-398-5043", whatsapp: "972533985043", email: "jack@jfrealty.co.il", portrait_url: null, slug: "jack-freedman", active: true, created_at: "" },
